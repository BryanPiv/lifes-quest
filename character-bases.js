window.LQCharacterBases={
  ...
  companions:{
    cloud:{
      ...
      forms:[
        {id:"cloud-1",name:"Nimbus",minLevel:1,art:window.LQJourneyConfig?.assets?.companions?.cloud?.runtime||"assets/characters/nimbus/nimbus-idle-premium-v95.webp?v=95",scale:1},
        {id:"cloud-2",name:"Nimbus Ascended",minLevel:5,art:window.LQJourneyConfig?.assets?.companions?.cloud?.runtime||"assets/characters/nimbus/nimbus-idle-premium-v95.webp?v=95",scale:1.08},
        {id:"cloud-3",name:"Nimbus Radiant",minLevel:10,art:window.LQJourneyConfig?.assets?.companions?.cloud?.runtime||"assets/characters/nimbus/nimbus-idle-premium-v95.webp?v=95",scale:1.15},
        {id:"cloud-4",name:"Nimbus Celestial",minLevel:20,art:window.LQJourneyConfig?.assets?.companions?.cloud?.runtime||"assets/characters/nimbus/nimbus-idle-premium-v95.webp?v=95",scale:1.22}
      ]
    },
    fire:{
