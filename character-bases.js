  ...
  companions:{
    cloud:{
      ...
      forms:[
        ...
        {id:"cloud-5",name:"Nimbus Eternal",minLevel:35,art:"assets/characters/evolution-atlas-v105.png?v=105",scale:1.29,tier:5,atlas:{row:0,col:4}}
      ]
    },
    fire:{
      ...
      forms:[
        ...
        {id:"fire-5",name:"Ember Eternal",minLevel:35,art:"assets/characters/evolution-atlas-v105.png?v=105",scale:1.29,tier:5,atlas:{row:1,col:4}}
      ]
    },
    water:{
      ...
      forms:[
        ...
        {id:"water-5",name:"Aurora Eternal",minLevel:35,art:"assets/characters/evolution-atlas-v105.png?v=105",scale:1.29,tier:5,atlas:{row:2,col:4}}
      ]
    },
    lightning:{
      ...
      forms:[
        ...
        {id:"lightning-5",name:"Volt Eternal",minLevel:35,art:"assets/characters/evolution-atlas-v105.png?v=105",scale:1.29,tier:5,atlas:{row:3,col:4}}
      ]
    },
    shadow:{
      ...
      forms:[
        ...
        {id:"shadow-5",name:"Nightfall Eternal",minLevel:35,art:"assets/characters/evolution-atlas-v105.png?v=105",scale:1.29,tier:5,atlas:{row:4,col:4}}
      ]
    }
  }
};
